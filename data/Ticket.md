...
格式化描述意为每增加1元可继续乘坐的公里数或区间数（“[]”内的数字表示区间数，2站=1区间、3站=2区间，依此类推）：
- 0, 0, 6, 6, 10, 10, 20~：起步价3元6公里，每增加1元可继续乘坐6、6、10、10、20公里，且32公里以上每20公里增加1元
- 0, [4], [5], [6], ∞：起步价2元4区间，每增加1元可继续乘坐5、6区间，且15区间以上封顶5元
- 0, 4, 4, 4, 6, 6, 8~：起步价2元4公里，每增加1元可继续乘坐4、4、6、6、8公里，且24公里以上每8公里增加1元
- 0, 5, 5, 5, 7, 7, 9~：起步价2元5公里，每增加1元可继续乘坐5、5、7、7、9公里，且29公里以上每9公里增加1元
- 0, 4, 5, 7, 9, +2~：起步价2元4公里，每增加1元可继续乘坐5、7、9公里，后续每增加1元可乘坐的公里数比上一区段递增2公里

| 城市 | 格式化描述 | 起步价/元 | 起步里程/km | 最大里程/km |
|---|---|---|---|---|
| 北京 | 0, 0, 6, 6, 10, 10, 20~ | 3 | 6 | 20 |
| 天津（除9号线中山门至东海路） | 0, [4], [5], [6], ∞  | 2 | [4] | 封顶5元 |
| 天津（9号线中山门至东海路） | 0.13元/km | 2 | 约15.38 | 全段9元 |
| 上海 | 0, 0, 6, 10~ | 3 | 6 | 10 |
| 广州、深圳、杭州、东莞、兰州、绍兴、佛山 | 0, 4, 4, 4, 6, 6, 8~ | 2 | 4 | 8 |
| 长春 | 0, 7, 6, 6, 8, 8, 10~ | 2 | 7 | 10 |
| 大连 | 0, 6, 6, 6, 8, 8, 10, 10, 15~ | 2 | 6 | 15 |
| 武汉、成都 | 0, 4, 4, 4, 6, 6, 8, 8, 10, 20~ | 2 | 4 | 20 |
| 重庆 | 0, 6, 5, 6, 7, 8, 9, 10, 12, ∞ | 2 | 6 | 封顶10元 |
| 南京 | 0, 4, 5, 5, 7, 7, 9, 11, 13, 15~ | 2 | 4 | 15 |
| 沈阳、哈尔滨 | 0, 6, 4, 4, 7, 7, 10~ | 2 | 6 | 10 |
| 西安 | 0, 6, 4, 4, 6, 6, 8~ | 2 | 6 | 8 |
| 苏州、长沙 | 0, 6, 5, 5, 7, 7, 9~ | 2 | 6 | 9 |
| 昆明 | 0, 4, 5, 7, 9, +2~ | 2 | 4 | +2 |
| 郑州 | 0, 6, 7, 8, 9~ | 2 | 6 | 9 |
| 宁波 | 0, 4, 4, 5, 7, 9~ | 2 | 4 | 9 |
| 无锡、福州、济南、常州 | 0, 5, 5, 5, 7, 7, 9~ | 2 | 5 | 9 |
| 青岛 | 0, 5, 5, 7, 10, 11, 20~ | 2 | 5 | 20 |
| 南昌 | 0, 6, 6, 8, 8, 10~ | 2 | 6 | 10 |
| 南宁 | 0, 6, 6, 6, 8, 8, 10~ | 2 | 6 | 10 |
| 合肥、芜湖 | 0, 8, 6, 7, 8, 9~ | 2 | 8 | 9 |
| 石家庄 | 0, 6, 7, 8, 9, 10~ | 2 | 6 | 10 |
| 贵阳 | 0, 4, 4, 6, 6, 8~ | 2 | 4 | 8 |
| 厦门 | 0, 4, 4, 4, 6, 10, 15, 20~ | 2 | 4 | 20 |
| 乌鲁木齐 | 0, 5, 4, 4, 6, 6, 8~ | 2 | 5 | 8 |
| 温州 | 0, 4, 4, 4, 4, 4, 4, 4, 6, 6, 6, 6, 6, 6, 8~ | 2 | 4 | 8 |
| 徐州 | 0, 6, 6, 6, 8, 8, 10, 15, 20~ | 2 | 6 | 20 |
| 呼和浩特 | 0, 5, 5, 5, 6, 7, 10~ | 2 | 5 | 10 |
| 太原 | 0, 5, 5, 5, 6, 6, 7~ | 2 | 5 | 7 |
| 洛阳 | 0, 6, 8, 8, 9~ | 2 | 6 | 9 |
| 金华、台州 | 0, 8, 4, 4, 4, 4, 4, 6, 6, 6, 6, 6, 6, 8~ | 2 | 8 | 8 |
| 南通 | 0, 6, 5, 5, 7, 7, 15, 20~ | 2 | 6 | 20 |
| *北京（原）* | 0, ∞ | 2 | ∞ | 2元一票制 |
| *武汉（原）* | 0, 9, 5, 7, 9, +2~ | 2 | 9 | +2 |
| *南京（原）* | 0, 10, 6, 6, 8, 8, 10, 10, 12, 14~ | 2 | 10 | 14 |
| *沈阳（原）* | 0, [8], [4], ∞ | 2 | 8 | 封顶4元 |
| *哈尔滨（原）* | 0, [8], [4], [5], ∞ | 2 | 8 | 封顶5元 |
| *以下数据暂缺* |
| 香港/ Hong Kong | | |
| 澳门/ Macao | | |
| 台北/ Taipei | | |
...
| 广州/ Guangzhou | 累额优惠（当月累计实际支付满80元不满200元部分8折，超200元部分5折） | 同地铁，且一起累计 | 公共交通乘车码纳入优惠；同一卡或同一乘车码入口累计；低收入居民善行卡5折（[来源](https://www.gz.gov.cn/zwfw/zxfw/jtfw/content/mpost_9178409.html)） |
